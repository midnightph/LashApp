...
export default function Cadastro({ navigation }: any) {
  ...
  const [telefone, setTelefone] = useState('41998780288');
  const [dataNasc, setDataNasc] = useState('26062008');
  const [nomeCompleto, setNomeCompleto] = useState('Pedro Henrique da Silva Rodacinski');
