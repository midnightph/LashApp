    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        <ScrollView style={styles.container} scrollEnabled={scrollEnabled} keyboardShouldPersistTaps="handled">
          <MotiText style={styles.label} from={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ type: 'timing', duration: 500 }}>Nome da cliente</MotiText>
          ...
          <MotiText style={styles.label} from={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ type: 'timing', duration: 900 }}>Procedimento</MotiText>
          <MotiView from={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ type: 'timing', duration: 1100 }} style={{ flex: 1 }}>
          <Picker
          ...
          {['Está grávida?', 'Tem alergia conhecida?', 'Usa lentes de contato?', 'Cliente ciente dos cuidados?'].map((label, idx) => {
            ...
            return (
              <MotiView key={label} style={styles.switchRow} from={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ type: 'timing', duration: 1300 }}>
          ...
          <MotiText style={styles.label} from={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ type: 'timing', duration: 1500 }}>Termo de Responsabilidade</MotiText>
          <MotiText style={styles.termo} from={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ type: 'timing', duration: 1700 }}>
          ...
          <MotiText style={styles.label} from={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ type: 'timing', duration: 1900 }}>Assinatura da cliente</MotiText>
          <MotiView style={styles.signatureContainer} from={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ type: 'timing', duration: 2100 }}>
            <Signature
              ref={signatureRef}
